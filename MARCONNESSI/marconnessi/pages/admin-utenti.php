...
<head>
    ...
    <style>
        ...
        .form-inline input, .form-inline select { margin:0 5px 10px 0; }
        .form-inline { display:flex; flex-wrap:wrap; align-items:center; gap:10px; }
        .btn-admin { background:#1976d2; color:#fff; border:none; border-radius:5px; padding:6px 16px; cursor:pointer; }
        .btn-admin:hover { background:#005b99; }
    </style>
</head>
<body>
<div class="container">
    <div style="display: flex; justify-content: flex-end; margin-bottom: 10px;">
        <a href="Home.php" class="btn-home-link">Torna alla Home</a>
    </div>
